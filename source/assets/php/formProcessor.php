...
// Create mail data
$headers = 'From: «ВоблаBeer» <info@mysite.ru>' . "\r\n";
...
$subject = 'Заявка с лендинга «ВоблаBeer»';

$phone = '';
$nameOrCity = '';
$htmlBody = "<html><body style='font-family:Arial,sans-serif;'5>";
$htmlBody .=
    "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Заявка с лендинга «ВоблаBeer»</h2>\r\n";
...
if (mail($sendto, $subject, $htmlBody, $headers)) {
    if (
        ...
        $customerSubject = 'Вы подали заявку на лендинге «ВоблаBeer»';
